      ...
      <div className="relative max-w-[1550px] mx-auto w-full z-[1]">
        <div className="flex flex-col gap-12 sm:gap-20 items-center justify-center mx-auto w-4/5 sm:w-3/5">
          <div className="flex flex-wrap text-4xl gap-y-4 gap-x-2 sm:gap-y-8 font-roboto sm:text-5xl md:text-6xl font-bold justify-center items-center text-center">
            <h1 className={"dark:text-white text-gray-900"}>Your vision,</h1>{" "}
            {""}
          ...
          <div className="bg-gradient-to-r from-[#FF7EED] to-[#d4a7ce] rounded-full p-0.5">
            <Link
              to={"/Download"}
              className={`group cursor-pointer font-bold flex items-center justify-center gap-4 md:gap-7 py-2 px-8 rounded-full transition-all duration-300 border border-[#FF7EED] text-base md:text-xl dark:bg-[#19021D] dark:text-white dark:hover:text-[#FF7EED] bg-white text-gray-900 hover:text-[#FF7EED]`}>
