...
export const ContactForm = () => {
  ...
  return (
    <div
      id="contact"
      className="relative dark:before:bg-[radial-gradient(circle_at_10%_90%,#2F1F6C_0%,black_40%_50%)] before:bg-[radial-gradient(circle_at_10%_90%,#ffe4f9_0%,white_40%_50%)] before:absolute before:left-0 before:top-0 before:z-[0] animate-fade-in before:w-full before:h-full pt-20 pb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    rows="4"
                    maxLength="250"
                    className="w-full px-4 py-2 border border-gray-400 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent resize-none"
                    placeholder="How can we help you?"
                    required></textarea>
                  <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                    {250 - formData.message.length} characters left
                  </p>
                </div>
              </div>
