...
import React, { useState, useEffect } from 'react';
  ...
  const [messages, setMessages] = useState([
    { id: 1, name: 'John Doe', email: 'john@example.com', subject: 'Question about services', message: 'I was wondering about your pricing plans...', status: 'pending' },
    { id: 2, name: 'Sarah Smith', email: 'sarah@example.com', subject: 'Technical support needed', message: 'I cannot access my account after the recent update.', status: 'pending' }
  ]);
  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      {/* Contact Form */}
      <div className="bg-gradient-to-br from-white via-white to-pink-100 rounded-xl shadow-lg overflow-hidden relative mb-8">
        {/* Pink circle decorations */}
        <div className="absolute -top-10 -right-10 w-48 h-48 rounded-full bg-pink-200 opacity-50 blur-md"></div>
        <div className="absolute -bottom-6 -left-6 w-32 h-32 rounded-full bg-pink-300 opacity-40 blur-md"></div>
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            {isLoggedIn && (
              <div className="text-sm text-gray-600">
                Logged in as <span className="font-medium">{formData.name}</span>
              </div>
            )}
          </div>
      ...
      {showAdminPanel && (
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="bg-gray-100 px-6 py-4 border-b">
            <h3 className="text-lg font-medium text-gray-800">Admin Message Panel</h3>
          </div>
              ...
              <div key={msg.id} className="p-6">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex space-x-2">
                    ...
                    >
                      {msg.status === 'responded' ? 'Responded' : 'Mark Responded'}
                    </button>
                    <button 
