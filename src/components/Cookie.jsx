    ...
    <div className=" fixed bottom-6 left-6 right-6 mx-auto max-w-5xl rounded-2xl shadow-xl border border-[#FF7EED] dark:border-white/50 bg-white dark:bg-gray-900 p-6 flex  items-center justify-between gap-8 z-50 h-24">
      ...
      <div className="flex items-center gap-4">
        <button
          ...
          className="bg-[#FF7EED] hover:bg-white hover:text-[#FF7EED] dark:bg-white/20 text-white transition-colors duration-300 font-bold rounded-full px-8 py-2 cursor-pointer shadow-md hover:shadow-lg text-base">
          Accept All
        </button>
        <button
          onClick={handleClose}
