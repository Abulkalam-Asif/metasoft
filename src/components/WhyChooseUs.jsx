  ...
  return (
    <section className="px-4">
      <motion.div
        ...
        className="max-w-7xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 border border-[var(--text-primary)]/50 rounded-3xl  bg-gradient-to-br from-[#1DFF3A]/80 via-[#1DFF3A]/60 to-white/20 dark:from-[#015e0d] dark:to-white/20 text-[var(--text-primary)] mb-8 py-6 mx-auto gap-x-2 px-4">
